                    ...
                    <form class="row g-3" style="padding-top: 0px;" method="post">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" maxlength="50" id="inputfirstname"
                                   name="firstname" required <?php if (isset($result['firstname'])) {
                                echo "value='" . $result['firstname'] . "'";
                            } ?>>
                        </div>
                        <div class="col-md-6">
                            <label for="inputlastname" class="form-label">Last Name *</label>
                            <input type="text" class="form-control" maxlength="50" id="inputlastname"
                                   name="lastname" required <?php if (isset($result['firstname'])) {
                                echo "value='" . $result['lastname'] . "'";
                            } ?>>
                        </div>
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" maxlength="50" id="inputUsername"
                                   name="username" readonly <?php if (isset($result['firstname'])) {
