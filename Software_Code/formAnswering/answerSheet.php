                ...
                if ($row['Type'] == 'text') {
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <textarea <?php if($row['required'] == 1){echo " required ";}?> class="card-text"
                ...
                ?>
                    <div class="card">
                        ...
                        foreach ($options as $option) {
                            ?>
                            <input <?php if($row['required'] == 1){echo " required ";}?> type="radio"
                                value="<?php echo $option['option']; ?>" name="<?php echo $row['ID']; ?>" />
