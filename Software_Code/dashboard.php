...
// if the user is not logged in, send them to the login page as they are not allowed to access this page
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                           style="margin-right: 3em;">
                            <!-- display the researcher's name if they have one, otherwise say "user" -->
                            Hello, <?php if (isset($name)) {
                                echo $name;
                            } else {
                                echo "user";
                            } ?>
                        </a>
                        <!-- the dropdown menu for the page -->
...
<div class="container">
    ...
    <!-- display all the options that the website can currently do -->
        ...
        <div class="col-md-4" align="center">
            <div class="card text-center" id="height">
                <div class="card-body">
                    ...
                    <div class="row" id="imageRow">
                        <p class="card-text">Use our analysis tool to help you tag and comment on synchronized
                            videos</p>
                    </div>
                    <!--href="new_Questionnaire.php"-->
                    <div class="row" id="imageRow">
        ...
        <div class="col-md-4" align="center">
            <div class="card text-center" id="height">
                <div class="card-body">
                    ...
                    <div class="row" id="imageRow">
                        <p class="card-text">Assign other researchers to your questionnaires, so they can view the data
                            collected</p>
                    </div>
                    <div class="row" id="imageRow">
        ...
        <div class="col-md-4" align="center">
            <div class="card text-center" id="height">
                <div class="card-body">
                    ...
                    <div class="row" id="imageRow">
                        <p class="card-text">Upload a video and use our tools to help manage themes and notes on you
                            transcipts</p>
                    </div>
                    <div class="row" id="imageRow">
...
<!-- the modal to agree to the ethics, this is activated when the user decides to create a new questionnaire-->
